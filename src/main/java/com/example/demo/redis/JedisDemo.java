...
public class JedisDemo {  
    ...
    *//** 
    ...
    public static void main(String args[]) {
    	JedisDemo.initialPool();
    	Jedis jedis=getJedis();
    	JedisDemo.setString("tyjj", "tengyujiao-jedis");
    	System.out.println(JedisDemo.getString("tyjj"));
    	Map<String,String> rmap=new HashMap<String,String>();
    	rmap.put("name","tyj-redis");
    	rmap.put("age","18");
    	jedis.set("jedismap",rmap);
